...
public class PayloadUsingPOJO2 {
	...
	public void createBooking() throws JsonProcessingException
	{
		...
		CreateBookingPayload2 createBookingPayload1 = new CreateBookingPayload2();
		createBookingPayload1.setFirstname("Amod");
		createBookingPayload1.setLastname("Mahajan");
		
		createBookingPayload1.setDepositpaid(false);
...
//		listOfPass.add(createBookingPayload2);
		...
		String payload = mapper.writerWithDefaultPrettyPrinter().writeValueAsString(createBookingPayload1);
